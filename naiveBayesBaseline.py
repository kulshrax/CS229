...
INSULT_TRAIN_FILE = 'insult_corpus_train_short.txt'
CLEAN_TRAIN_FILE = 'clean_corpus_train_short.txt'

INSULT_TEST_FILE = 'insult_corpus_test_short.txt'
CLEAN_TEST_FILE = 'clean_corpus_test_short.txt'
