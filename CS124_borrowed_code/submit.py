...
def submit(partId):
    print "==\n== [cs124] Submitting Solutions | Programming Exercise %s\n==" % homework_id()
    if(not partId):
        partId = promptPart()
    ...
    for partId in submitParts:
        ...
        print '\n== [cs124] Submitted Homework %s - Part %d - %s' % \
...
def challenge_url():
    ...
    return 'https://stanford.coursera.org/cs124-003/assignment/challenge'


def submit_url():
    """Returns the submission url."""
    return 'https://stanford.coursera.org/cs124-003/assignment/submit'
